...
class ImageNetDataset_RTG(ImageNetDataset_Base):
...
class ImageNetDataset(ImageNetDataset_Base):
    def __init__(self, retrieved_text_path, root=None, transform=None, text_transform=None, num_tags=0, num_attributes=0):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            print("without id")
            descriptive_text = "A photo of an object."
        ...
        return img, label, image_id, descriptive_text_token, uq_idx
...
def get_imagenet_100_datasets(train_transform, 
    ...
    imagenet_training_set = ImageNetDataset(root=os.path.join(args.imagenet_root, 'train'), retrieved_text_path=args.imagenet_retrieved_text_path, transform=train_transform, text_transform=text_transform, num_tags=args.num_tags, num_attributes=args.num_attributes)
    ...
    test_dataset = ImageNetDataset(root=os.path.join(args.imagenet_root, 'val'), retrieved_text_path=args.imagenet_retrieved_text_path, transform=test_transform, text_transform=text_transform, num_tags=args.num_tags, num_attributes=args.num_attributes)
...
def get_imagenet_1k_datasets(train_transform, 
    ...
    # Init entire training set
    whole_training_set = ImageNetDataset(root=os.path.join(args.imagenet_root, 'train'), retrieved_text_path=args.imagenet_retrieved_text_path, transform=train_transform, text_transform=text_transform, num_tags=args.num_tags, num_attributes=args.num_attributes)
    ...
    # Get test set for all classes
    test_dataset = ImageNetDataset(root=os.path.join(args.imagenet_root, 'val'), retrieved_text_path=args.imagenet_retrieved_text_path, transform=test_transform, text_transform=None, num_tags=args.num_tags, num_attributes=args.num_attributes)
